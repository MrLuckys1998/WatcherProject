...
<div class="container py-5">
  ...
  <form method="post" class="bg-white p-4 rounded shadow-sm">
    ...
    <div class="mb-3">
      ...
      <textarea name="condition_script" class="form-control" rows="6">{% if condition_script %}{{ condition_script }}{% else %}if result['hits']['total']['value'] > 0:
        logger.info('Se encontraron resultados'){% endif %}</textarea>
    </div>
    {% endif %}
